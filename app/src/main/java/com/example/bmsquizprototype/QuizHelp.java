package com.example.bmsquizprototype;
...
public class QuizHelp extends SQLiteOpenHelper {
    ...
    private static QuizHelp instance;

    private SQLiteDatabase db;

    QuizHelp(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    public static QuizHelp getInstance(Context context) {
        if (instance == null) {
            instance = new QuizHelp(context.getApplicationContext());
        }
        return instance;
    }
